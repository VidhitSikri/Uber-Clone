  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="fixed w-full translate-y-full z-10 bottom-0 bg-white px-3 py-6">
        ...
        <div className="flex active:border-2 active:border-black bg-gray-100 mb-2 rounded-xl w-full justify-between items-center p-3">
          ...
          <h2 className="text-xl font-semibold">₹130.20</h2>
        </div>
        <div className="flex active:border-2 active:border-black bg-gray-100 mb-2 rounded-xl w-full justify-between items-center p-3">
        ...
        <div className="flex active:border-2 active:border-black bg-gray-100 mb-2 rounded-xl w-full justify-between items-center p-3">
          ...
          <h2 className="text-xl font-semibold">₹87.20</h2>
        </div>
      </div>
    </div>
  );
